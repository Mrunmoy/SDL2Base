...
set(SDL2_DIR "${CMAKE_CURRENT_LIST_DIR}/../SDL2-2.0.20" CACHE PATH "SDL2 directory")
set(SDL2_INCLUDE_DIR "${CMAKE_CURRENT_LIST_DIR}/../SDL2-2.0.20" CACHE PATH "SDL2 Include directory")

message (STATUS, "SDL2 DIR: ${SDL2_DIR}")
message (STATUS, "SDL2 INC DIR: ${SDL2_INCLUDE_DIR}")
# if(NOT SDL2_DIR)
